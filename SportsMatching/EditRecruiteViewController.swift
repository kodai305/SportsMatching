            ...
            if let document = document, document.exists {
                ...
                self.form +++
                    ...
                    <<< PushRow<String>("Prefecture") {
                        ...
                        $0.value = document.data()!["prefecture"] as? String
                        }.onPresent { from, to in
                    ...
                    <<< TextRow("Place"){
                        ...
                        $0.value = document.data()!["place"] as? String
                    }
                    <<< ActionSheetRow<String>("ApplyGender") {
                        $0.title = "募集性別"
                        $0.selectorTitle = "募集する性別を選択"
                        $0.options = ["不問", "男性", "女性"]
                        $0.value = document.data()!["applyGender"] as? String
                        }
                        .onPresent { from, to in
                            to.popoverPresentationController?.permittedArrowDirections = .up
                    }
                ...
                self.form +++ Section(header: "任意項目", footer: "応募者が参考にするため、なるべく入力してください")
                    ...
                    <<< ActionSheetRow<String>("GenderRatio") {
                        ...
                        $0.value = document.data()!["genderRatio"] as? String
                        }
                        .onPresent { from, to in
                            to.popoverPresentationController?.permittedArrowDirections = .up
                    }
                    <<< ActionSheetRow<String>("TeamLevel") {
                        ...
                        $0.value = document.data()!["teamLevel"] as? String
                        }
                        .onPresent { from, to in
                            to.popoverPresentationController?.permittedArrowDirections = .up
                    }
                    <<< IntRow("NumMembers"){
                        ...
                        $0.value = document.data()!["numMembers"] as? Int
                    }
